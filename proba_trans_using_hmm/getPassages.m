...
%   @groundTruthData: the annotation for vibrato or portamento or anything
%   else. [start(s):(pitch):duration(s)]
%   @timeShift: temporary variable 
%   output:
%   @passages: the struct the contains passage clips. [normalised time(s):pitch:original time(s)]
